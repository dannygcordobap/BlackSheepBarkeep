      ...
      <div className="card shadow">
          ...
          <div className="col ">
            <div className="container">
              ...
              {drink.Ingredients.length > 0 ? (
                ...
                <div>It looks like this recipe is missing the ingredients!</div>
              )}
            </div>
          </div>
        </div>
        <div className="card-footer">
          ...
          {drink.Steps.length > 0 ? (
            ...
            <div>It looks like this recipe is missing the directions!</div>
          )}
        </div>
      </div>
    </div>
